...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/bartok_bagatelles.git
...
* `Béla Bartók – 14 Bagatelles, Op. 6 <https://github.com/DCMLab/bartok_bagatelles/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first Bagatelle has the following files:
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/op06n01.tsv')
   notes = ms3.load_tsv('notes/op06n01.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/bartok_bagatelles/issues>`__ and feel free to fork and submit pull requests.
